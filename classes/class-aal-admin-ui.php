...
class AAL_Admin_Ui {
    ...
    protected $title = 'Thống kê lịch sử';
	...
	public function create_admin_menu() {
		...
		$this->_screens['main'] = add_menu_page( _x( $this->title, 'Page and Menu Title', 'aryo-activity-log' ), _x( $this->title, 'Page and Menu Title', 'aryo-activity-log' ), $menu_capability, 'activity_log_page', array( &$this, 'activity_log_page_func' ), '', '2.1' );
	...
	public function activity_log_page_func() {
		...
		?>
		<div class="wrap">
			<h1 class="aal-page-title"><?php _ex( $this->title, 'Page and Menu Title', 'aryo-activity-log' ); ?></h1>
